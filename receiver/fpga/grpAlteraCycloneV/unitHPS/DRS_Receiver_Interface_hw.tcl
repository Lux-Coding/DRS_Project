...
# Thu Jan 11 23:37:13 CET 2024
# DO NOT MODIFY


# 
# DRS_Receiver_Interface "DRS-Receiver-Interface" v1.0
# MH 2024.01.11.23:37:13
# blah
# 
...
add_interface_port rsi_reset_n rsi_reset_n reset_n Input 1
...
add_interface_port oByteDetected_int oByteDetected_int irq Output 1
...
# 
# connection point iByteDetected_1
# 
add_interface iByteDetected_1 conduit end
set_interface_property iByteDetected_1 associatedClock csi_clk
set_interface_property iByteDetected_1 associatedReset rsi_reset_n
set_interface_property iByteDetected_1 ENABLED true
set_interface_property iByteDetected_1 EXPORT_OF ""
set_interface_property iByteDetected_1 PORT_NAME_MAP ""
set_interface_property iByteDetected_1 CMSIS_SVD_VARIABLES ""
set_interface_property iByteDetected_1 SVD_ADDRESS_GROUP ""

add_interface_port iByteDetected_1 iByteDetected ibytedetected Input 1
add_interface_port iByteDetected_1 oByteDetectedAck obytedetectedack Output 1
add_interface_port iByteDetected_1 oByteDetected_int_cond obytedetected_int_cond Output 1
